 ...
 */
char *strcat_cd(data_shell *data_sh, char *message, char *error, char *ver_str)
{
	char *illegal_flag;
 ...
 * @data_sh: data relevant or directory
 *
 * Return: Error message
 */
char *error_get_cd(data_shell *data_sh)
{
	...
	length = _strlen(data_sh->av[0]) + _strlen(datash->args[0]);
